...
q_ano1=(q[81,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano2=(q[93,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano3=(q[489,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano4=(q[765,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano5=(q[777,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano6=(q[141,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano7=(q[153,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano8=(q[429,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano9=(q[477,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano10=(q[525,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano11=(q[657,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano12=(q[837,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
q_ano13=(q[849,7,:,:]-q_c[9,7,:,:]).reshape(1,81,360)
...
plt.savefig('D:/figure/改文章6/10月300hPa热源.pdf',dpi=300,bbox_inches='tight')  