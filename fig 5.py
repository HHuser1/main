...
f2=xr.open_dataset('D:/data/FAMIPC5_NA_composite_REALwarm_VerticalTransfer_Z3_monthly.nc')
f3=xr.open_dataset('D:/FAMIPC5_Med_composite_REALwarm_VerticalTransfer_Z3_monthly.nc')
f4=xr.open_dataset('D:/data/FAMIPC5_inputdata_forcing_climatol_1x1_2.nc')
f5=xr.open_dataset('D:/FAMIPC5_inputdata_REALforcing_NA_composite_1x1.nc')
f6=xr.open_dataset('D:/FAMIPC5_inputdata_REALforcing_Med_composite_1x1.nc')
...
c1=ax.contourf(cyclic_lons1,lat1,sst_med_ano,transform=ccrs.PlateCarree(),cmap=cmap,zorder=0,levels=np.arange(-1,1.1,0.1))
...
ax1.add_feature(cfeature.LAND,color='w')#给陆地填色
...
c1=ax1.contourf(cyclic_lons1,lat1,sst_na_ano,transform=ccrs.PlateCarree(),levels=np.arange(-1,1.1,0.1),zorder=0,cmap=cmap,extend='both')
...
clb=plt.colorbar(c1,cax=position,orientation='vertical',format='%.1f',ticks=[-1.2,-0.8,-0.4,0,0.4,0.8,1.2])
...
#plt.savefig('D:/figure/改文章6/新的FAMIPC5sst和hgt组图.png',bbox_inches='tight',dpi=300)
