...
f1=xr.open_dataset('E:/lbm/out1/2atlantic/linear.t42l21.nc',decode_times=False)


aaa=np.array(f1.z.loc[:,500,87.8638:-2,:])
lon=np.array(f1.lon)
...
c2=ax.contour(cyclic_lons,lat,z5,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[2,4,6],colors='r',linestyles='-',linewidths=1.5)
c3=ax.contour(cyclic_lons,lat,z5,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[-6,-4,-2],colors='blue',linestyles='-',linewidths=1.5)
...
d=Ellipse(xy=(343,53),width=26,height=10,facecolor='blue',linewidth=2,linestyle='-',zorder=0,edgecolor='none',transform=ccrs.PlateCarree())
ax.add_patch(d)
...
c2=ax1.contour(cyclic_lons,lat,z10,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[2,4,6],colors='r',linestyles='-',linewidths=1.5)
c3=ax1.contour(cyclic_lons,lat,z10,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[-6,-4,-2],colors='blue',linestyles='-',linewidths=1.5)
...
c2=ax2.contour(cyclic_lons,lat,z15,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[2,4,6],colors='r',linestyles='-',linewidths=1.5)
c3=ax2.contour(cyclic_lons,lat,z15,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[-6,-4,-2],colors='blue',linestyles='-',linewidths=1.5)
...
c2=ax3.contour(cyclic_lons,lat,z20,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[2,4,6],colors='r',linestyles='-',linewidths=1.5)
c3=ax3.contour(cyclic_lons,lat,z20,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[-6,-4,-2],colors='blue',linestyles='-',linewidths=1.5)
...
c2=ax4.contour(cyclic_lons,lat,z25,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[2,4,6],colors='r',linestyles='-',linewidths=1.5)
c3=ax4.contour(cyclic_lons,lat,z25,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[-6,-4,-2],colors='blue',linestyles='-',linewidths=1.5)
...
c2=ax5.contour(cyclic_lons,lat,z30,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[2,4,6],colors='r',linestyles='-',linewidths=1.5)
c3=ax5.contour(cyclic_lons,lat,z30,transform=ccrs.PlateCarree(),extend='both',zorder=1,levels=[-6,-4,-2],colors='blue',linestyles='-',linewidths=1.5)
...
f5=xr.open_dataset('E:/lbm/frc1/2atlantic/frc.t42l21.nc',decode_times=False)
print(f5)
...
t=np.arange(0,11,1)
font={'family':'Arial'}
totalq_ano_mean=np.array([-0.1481,-0.3934,-0.4233,-0.559643,-0.4929,-0.4418,-0.4251,-0.4495,-0.447503,-0.3908,-0.0485])
totalq_ano_mean=totalq_ano_mean*2
ax6 = fig.add_axes([-0.17, 0.67, 0.16, 0.2])
#ax.set_yscale('symlog')
ax6.set_yticks([0,2,4,6,4,5,6,7,8,9,10])
...
plt.savefig('D:/figure改文章12-25/大西洋lbm.png',format='png',bbox_inches='tight',dpi=300)