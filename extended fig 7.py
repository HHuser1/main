...
f1=xr.open_dataset('E:/lbm/out1/2medite/linear.t42l21.nc',decode_times=False)
...
'''
f5=xr.open_dataset('E:/lbm/frc1/2medite/frc.t42l21.nc',decode_times=False)
print(f5)
...
plt.savefig('D:/figure改文章12-25/地中海lbm.png',format='png',bbox_inches='tight',dpi=300)